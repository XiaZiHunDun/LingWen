...
def main():
    ...
    parser.add_argument("--chapters", type=str, default="1-30", help='章节范围，如 "1-30" 或 "1,5,10"')
    parser.add_argument("--sample", action="store_true", help="随机抽样模式")
    parser.add_argument("--sample-size", type=int, default=30, help="抽样数量")
