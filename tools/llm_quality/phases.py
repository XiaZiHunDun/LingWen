...
def run_phase_18a(
    checker: LLMQualityChecker, chapters: List[int], parallel: bool = True
        ...
        with ThreadPoolExecutor(max_workers=5) as executor:
            ...
            for future in as_completed(futures):
                ...
                try:
                    ...
                    print(
                        f"  ch{ch:03d}: {len(report.issues)}个问题 {severity_counts} score={report.score:.2f}"
                    )
...
def run_phase_18e(
    repairer: LLMRepairer, issues: List[Issue], chapters_dir: Path, dry_run: bool = False
) -> Dict[int, str]:
    """STEP_18e: 质量问题修复"""
