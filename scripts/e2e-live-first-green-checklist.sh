...
echo "   bash scripts/write-e2e-live-first-green-record.sh --local-only"
echo "   # or after remote green:"
echo "   bash scripts/write-e2e-live-first-green-record.sh --github-run-id RUN_ID --github-run-url URL"
echo "   Stub: $STUB"
echo ""
if [ -f "$WF_PATH" ]; then
