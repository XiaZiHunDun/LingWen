...
class TestMasterControllerBudget:
    ...
    def test_run_workflow_generates_run_id_uuid4_hex(self, tmp_state_dir: Path) -> None:
    ...
    def test_run_workflow_calls_budget_service_set_run(self, tmp_state_dir: Path) -> None:
    ...
    def test_run_workflow_no_budget_service_does_not_call_set(self, tmp_state_dir: Path) -> None:
    ...
    def test_run_workflow_finally_resets_budget_state(self, tmp_state_dir: Path) -> None:
    ...
    def test_old_run_workflow_signature_still_works(self, tmp_state_dir: Path) -> None:
...
class TestMasterControllerByTier:
    ...
    def test_master_controller_accepts_budget_service_by_tier_kwarg(self, tmp_state_dir: Path) -> None:
    ...
    def test_master_controller_default_budget_service_by_tier_none(self, tmp_state_dir: Path) -> None:
    ...
    def test_master_controller_passes_budget_service_by_tier_to_scheduler(self, tmp_state_dir: Path) -> None:
