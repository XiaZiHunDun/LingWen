...
| **最新 CI** | `test` + `Dashboard Frontend CI` @ **`7e34133f`**（批次 6） |
...
| **Human-first 批次 7（发布链路 E2E）** | ✅ | 见最新 commit · 发布→导出 submission · stub 提交成功 · Live E2E **66** |
...
| e2e-live | Playwright live-backend **66** 项 · 在 `dashboard-frontend-ci.yml` blocking |
