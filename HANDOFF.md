...
> **版本**: v10.53 (prose judge v2 · 抽检表, 2026-06-20)  
> **更新 (2026-06-20)**: prose-judge schema/API/Dashboard · calibration-log · 七书 offline judge
...
| **下一期推荐** | **人工 prose 抽检填表**（误报率 KPI）· Playwright 默认 CI |
