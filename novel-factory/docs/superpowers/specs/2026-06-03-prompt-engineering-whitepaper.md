...
> **用户确认 (2026-06-03)**：《吞噬星空》为必选蒸馏源 (玄幻头部标杆, 升级流/战力体系/宇宙扩张范式)。
> 其余 4 本按题材互补选取, 总数 5 本不变。

**必选清单：**

| 序 | 书名 | 题材 | 蒸馏重点 |
|----|------|------|---------|
| 1 | **《吞噬星空》** (我吃西红柿) | 玄幻·升级流 | **必选** — 升级节奏/战力体系/宇宙扩张/主角心理 |
| 2 | 待选 (都市/言情/历史/科幻 各 1) | - | 题材互补, 主公定 |
...
6. **战力蒸馏**：升级节点的章节分布 + 数值跃迁曲线
7. **宇宙蒸馏**：世界观扩张的"卷-阶段"模式 (地球→宇宙→域外)

输出物：`assets/genre_knowledge/xuanhuan_burning.yaml` (以吞噬星空为主源), 喂给 writer_role_config。

**变更记录**:
- v1.0 (2026-06-03): 初始提议
- v1.0.1 (2026-06-03): 用户确认吞噬星空为必选, 加 #6 战力蒸馏 + #7 宇宙蒸馏
