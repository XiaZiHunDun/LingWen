...
def test_core_foreshadow_checker_init():
    ...
    from consistency.checkers.core_foreshadow_checker import CoreForeshadowChecker
...
def test_foreshadow_issue_dataclass():
    ...
    from consistency.checkers.core_foreshadow_checker import ForeshadowIssue
