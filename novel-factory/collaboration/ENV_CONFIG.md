...
| 变量名 | 说明 | 默认值 | 示例 |
|--------|------|--------|------|
| `LINGWEN_PROJECT_ROOT` | 项目根目录 | 当前目录 | `/home/ailearn/projects/LingWen/novel-factory` |
...
```bash
# 1. 进入项目目录
cd /y/home/ailearn/projects/AI-Incursion/domains/IP创作/projects/LingWen/novel-factory
