...
Type=simple
User=ailearn
WorkingDirectory=/home/ailearn/projects/AI-Incursion/domains/IP创作/projects/LingWen/novel-factory
Environment=LINGWEN_PROJECT_ROOT=/home/ailearn/projects/AI-Incursion/domains/IP创作/projects/LingWen/novel-factory
Environment=MINIMAX_API_KEY=sk-xxx
ExecStart=/home/ailearn/projects/AI-Incursion/domains/IP创作/projects/LingWen/novel-factory/venv/bin/uvicorn dashboard.app:app --host 0.0.0.0 --port 8000 --workers 4
Restart=always
RestartSec=5
...
server {
    ...
    # 前端静态文件
    location / {
        root /home/ailearn/projects/LingWen/novel-factory/dashboard/frontend/dist;
