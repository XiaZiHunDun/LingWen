...
| ID | 标题 | 描述 | 认领人 | 状态 | 创建日期 |
|----|------|------|--------|------|----------|
| P1-H2 | FastAPI中间件 | CORS/GZip/限流中间件 | 待认领 | 📋 待开始 | 2026-07-13 |
| P1-H4 | Ripple N+1优化 | 200 ripple → 2 query | 待认领 | 📋 待开始 | 2026-07-13 |
| P1-M4 | CLI路径校验 | `$LINGWEN_PROJECT_ROOT`环境变量校验 | 待认领 | 📋 待开始 | 2026-07-13 |
| P1-L6 | Shell脚本修复 | 6个硬编码slug脚本 | 待认领 | 📋 待开始 | 2026-07-13 |

> **已完成**: P1-H10（前端API timeout）已实现
...
| ID | 标题 | 描述 | 认领人 | 状态 | 创建日期 |
|----|------|------|--------|------|----------|
| P2-E4 | Cascade邻接表 | 缺失邻接表导致性能问题 | 待认领 | ⏳ 待规划 | 2026-07-13 |
| P2-E5 | 全表加载 | `reference_graph.py`全表加载 | 待认领 | ⏳ 待规划 | 2026-07-13 |
| P2-E6 | Cascade cycle指标 | 缺失循环检测指标 | 待认领 | ⏳ 待规划 | 2026-07-13 |
| P2-E10 | Qdrant异步迁移 | Qdrant阻塞事件循环 | 待认领 | ⏳ 待规划 | 2026-07-13 |
...
| P15-T2 | SQLite整合spec | SQLite 8类 → `infra/persistence/` | 待认领 | ⏳ 待规划 | 2026-07-13 |
...
| P4-DETECTOR | AI检测器合并 | 重复检测器/loader合并 | 待认领 | ⏳ 待规划 | 2026-07-13 |
