  ...
  >
    <aside class="write-workbench__left" data-testid="write-workbench-left">
      ...
      <template v-if="!wb.leftPanelCollapsed">
        <div class="write-workbench__section" data-testid="write-section-core">
          <div class="write-workbench__section-header">
            <span class="write-workbench__section-icon">✏️</span>
            <span class="write-workbench__section-title">写作核心</span>
          </div>
        ...
        <div class="write-workbench__section" data-testid="write-section-ai">
          <div class="write-workbench__section-header">
            <span class="write-workbench__section-icon">🤖</span>
            <span class="write-workbench__section-title">AI 辅助</span>
          </div>
        ...
        <div class="write-workbench__section" data-testid="write-section-consistency">
          <div class="write-workbench__section-header">
            <span class="write-workbench__section-icon">✅</span>
            <span class="write-workbench__section-title">一致性检查</span>
          </div>
        ...
        <div v-if="wb.isLeftRailPanelVisible('versionCheckpointList')" class="write-workbench__section" data-testid="write-section-version">
          <div class="write-workbench__section-header">
            <span class="write-workbench__section-icon">📦</span>
            <span class="write-workbench__section-title">版本管理</span>
          </div>
          <details
            class="write-workbench__card"
...
.write-workbench__section-header {
  display: flex;
  align-items: center;
  gap: 6px;
...
.write-workbench__section-icon {
  font-size: var(--text-xs);
}

.write-workbench__section-title {
  flex: 1;
}
