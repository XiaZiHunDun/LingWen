...
**当前基线（2026-07-08）**：Vitest **998** · Live E2E **63** · 可选 LLM E2E **1** · 视觉回归 **18** · a11y L1 **7** · UI metrics **10** · Vite smoke **1** · 测试 `typecheck`（relaxed + **strict 清零**）**CI 门禁** · 覆盖率 lines **80%** / branches **70%** / statements **80%**。
