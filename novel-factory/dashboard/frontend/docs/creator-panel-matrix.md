...
| `LINGWEN_E2E_LIVE=1 pnpm e2e:live` | Live 行为 E2E（55 项，需 `dashboard/e2e_entry.py`） |
...
**当前基线（2026-07-07）**：Vitest **779** · Live E2E **55** · 可选 LLM E2E **1** · 视觉回归 **18** · a11y L1 **7** · UI metrics **10** · Vite smoke **1**。
