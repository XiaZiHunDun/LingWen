...
assert resolve_creator_ui_profile(creation_mode="advance")["volume_plan_diff_volume_filter"] is True
assert resolve_creator_ui_profile(creation_mode="advance")["batch_history_avg_duration"] is True
assert resolve_creator_ui_profile(creation_mode="companion")["creation_mode_yaml_snippet"] is True
assert resolve_creator_ui_profile(creation_mode="advance")["volume_plan_diff_export_outline"] is True
assert resolve_creator_ui_profile(creation_mode="advance")["batch_history_failure_trend"] is True
assert resolve_creator_ui_profile(creation_mode="studio")["creation_mode_switch_doc_open"] is True
assert resolve_creator_ui_profile(creation_mode="advance")["volume_plan_diff_export_highlight"] is True
assert resolve_creator_ui_profile(creation_mode="advance")["batch_history_weekly_summary"] is True
assert resolve_creator_ui_profile(creation_mode="companion")["creation_mode_capability_matrix"] is True
...
assert resolve_creator_ui_profile(creation_mode="advance")["volume_plan_diff_export_pdf"] is True
assert resolve_creator_ui_profile(creation_mode="advance")["batch_history_failure_reason_label"] is True
assert resolve_creator_ui_profile(creation_mode="studio")["creation_mode_switch_confirm_dialog"] is True
assert resolve_creator_ui_profile(creation_mode="advance")["volume_plan_diff_export_print_preview"] is True
assert resolve_creator_ui_profile(creation_mode="advance")["batch_history_status_stack_chart"] is True
assert resolve_creator_ui_profile(creation_mode="companion")["creation_mode_switch_history"] is True
...
assert resolve_creator_ui_profile(creation_mode="advance")["volume_plan_diff_share_link_preview"] is True
assert resolve_creator_ui_profile(creation_mode="advance")["batch_history_queue_depth_chart"] is True
assert resolve_creator_ui_profile(creation_mode="studio")["creation_mode_switch_speech"] is True
