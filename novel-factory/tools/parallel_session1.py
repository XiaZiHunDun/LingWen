...
log_file = '/home/ailearn/projects/AI-Incursion/domains/IP创作/projects/LingWen/novel-factory/logs/minimax_review/session1.log'

def log(msg):
    print(f"[S1] {msg}", flush=True)
...
log("Starting session 1: ch001-ch060")
...
with open('/home/ailearn/projects/AI-Incursion/domains/IP创作/projects/LingWen/novel-factory/logs/minimax_review/session1_results.json', 'w') as f:
