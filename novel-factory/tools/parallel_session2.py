...
log_file = '/home/ailearn/projects/AI-Incursion/domains/IP创作/projects/LingWen/novel-factory/logs/minimax_review/session2.log'
...
log("Starting session 2: ch61-ch120")
reviewer = MiniMaxReviewer(api_key)
results = []
start = datetime.now()

for ch in range(61, 120 + 1):
...
with open('/home/ailearn/projects/AI-Incursion/domains/IP创作/projects/LingWen/novel-factory/logs/minimax_review/session2_results.json', 'w') as f:
