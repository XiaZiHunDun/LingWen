...
log_file = '/home/ailearn/projects/AI-Incursion/domains/IP创作/projects/LingWen/novel-factory/logs/minimax_review/session4.log'
...
log("Starting session 4: ch181-ch240")
reviewer = MiniMaxReviewer(api_key)
results = []
start = datetime.now()

for ch in range(181, 240 + 1):
...
with open('/home/ailearn/projects/AI-Incursion/domains/IP创作/projects/LingWen/novel-factory/logs/minimax_review/session4_results.json', 'w') as f:
