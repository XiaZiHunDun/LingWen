...
log_file = '/home/ailearn/projects/AI-Incursion/domains/IP创作/projects/LingWen/novel-factory/logs/minimax_review/session5.log'

def log(msg):
    print(f"[S5] {msg}", flush=True)
...
log("Starting session 5: ch241-ch300")
reviewer = MiniMaxReviewer(api_key)
results = []
start = datetime.now()

for ch in range(241, 300 + 1):
...
with open('/home/ailearn/projects/AI-Incursion/domains/IP创作/projects/LingWen/novel-factory/logs/minimax_review/session5_results.json', 'w') as f:
