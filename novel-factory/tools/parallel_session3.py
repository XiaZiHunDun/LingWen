...
log_file = '/home/ailearn/projects/AI-Incursion/domains/IP创作/projects/LingWen/novel-factory/logs/minimax_review/session3.log'
...
log("Starting session 3: ch121-ch180")
reviewer = MiniMaxReviewer(api_key)
results = []
start = datetime.now()

for ch in range(121, 180 + 1):
...
with open('/home/ailearn/projects/AI-Incursion/domains/IP创作/projects/LingWen/novel-factory/logs/minimax_review/session3_results.json', 'w') as f:
