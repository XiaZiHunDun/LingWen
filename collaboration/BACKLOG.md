...
| P2-ARCHDEBT (剩余) | infra.got.* → packages/lingwen-got/ 迁移 | v32.0 已清 3 个 PHASE-COMPAT shim + world_model/__init__ split 待办；Phase 33+ 候选剩余：infra.got.* 迁 packages/lingwen-got/ + world_model/__init__ split (5 consumer migration) | 后端 B（自服务） | 📋 待开始 | 2026-09-07 |
