...
Phase 51 P3-ARCHDEBT: relocated verbatim from infra/project_characters.py (89 LOC).
Provides 2 public funcs: load_project_character_names + load_agency_target_characters.
"""
...
from lingwen_paths import ProjectPaths  # Phase 37
