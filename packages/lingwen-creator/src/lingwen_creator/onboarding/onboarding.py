...
def _unread_mention_count(project_root) -> int:
    from lingwen_creator.onboarding.notifications import unread_mention_count
...
def dismiss_onboarding_wizard_panel(project: StudioProject) -> dict[str, Any]:
    from lingwen_creator.onboarding.progress import dismiss_wizard_panel
...
def save_onboarding_wizard_panel_collapsed(
    ...
    *,
    ...
    from lingwen_creator.onboarding.progress import save_wizard_panel_collapsed
