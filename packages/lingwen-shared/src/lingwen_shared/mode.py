...
Originally extracted to lingwen_creator/shared/mode.py, but that placement
violated the layering invariant (infra is leaf; must NOT import from
lingwen_creator). Phase 126 v16.3 closes this gap by moving to lingwen_shared
(true leaf). lingwen_creator/shared/mode.py now re-exports for back-compat.
