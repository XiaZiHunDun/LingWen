...
class TestBackfillE2E:
    def test_backfill_runs_on_10_chapter_fixture(self, tmp_path):
        ...
        # fixture dir 在 packages/lingwen-cross-volume/tests/fixtures/
        # (Phase 56c: cwd-independence + relative import — Phase 56b2 lesson)
        from lingwen_cross_volume.backfill import (
            Backfiller,  # Phase 9.11: Task 6 cleanup (remove namespace hack)
        )
        from .fixtures.sample_corpus import SAMPLE_CORPUS_ROOT, SAMPLE_RULES_YAML
