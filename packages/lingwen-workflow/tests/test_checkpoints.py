"""Tests for lingwen_workflow.checkpoints (create/list/restore/delete).
...
class TestCreateCheckpoint:
    ...
    def test_create_checkpoint_returns_checkpoint_id(self, init_db):
        ...
        from lingwen_workflow import create_checkpoint, set_state
    ...
    def test_create_checkpoint_stores_snapshot(self, init_db):
        ...
        from lingwen_workflow import create_checkpoint, list_checkpoints
    ...
    def test_create_checkpoint_includes_state(self, init_db):
        ...
        from lingwen_workflow import create_checkpoint, list_checkpoints, set_state
    ...
    def test_create_checkpoint_multiple_checkpoints(self, init_db):
        ...
        from lingwen_workflow import create_checkpoint, delete_checkpoint, list_checkpoints
...
class TestListCheckpoints:
    ...
    def test_list_checkpoints_returns_list(self, init_db):
        ...
        from lingwen_workflow import list_checkpoints
...
class TestRestoreCheckpoint:
    ...
    def test_restore_checkpoint_returns_true_on_success(self, init_db):
        ...
        from lingwen_workflow import create_checkpoint, restore_checkpoint, set_state
    ...
    def test_restore_checkpoint_returns_false_for_missing(self, init_db):
        ...
        from lingwen_workflow import restore_checkpoint
    ...
    def test_restore_checkpoint_restores_state(self, init_db):
        ...
        from lingwen_workflow import create_checkpoint, get_state, restore_checkpoint, set_state
...
class TestDeleteCheckpoint:
    ...
    def test_delete_checkpoint_returns_true(self, init_db):
        ...
        from lingwen_workflow import create_checkpoint, delete_checkpoint
