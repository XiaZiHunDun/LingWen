"""Tests for lingwen_workflow.state (get_state, set_state, advance_step, get_json).
...
`lingwen_workflow.events._trigger_event` (the lib.events module
...
class TestGetState:
    ...
    def test_get_state_returns_value(self, init_db):
        ...
        from lingwen_workflow import get_state, set_state
    ...
    def test_get_state_returns_fallback_when_missing(self, init_db):
        ...
        from lingwen_workflow import get_state
    ...
    def test_get_state_falls_back_to_json(self, sample_workflow_json):
        ...
        from lingwen_workflow import DB_PATH, get_state
...
class TestAdvanceStep:
    ...
    def test_advance_step_valid_transition(self, init_db):
        ...
        from lingwen_workflow import advance_step, get_state, set_state
    ...
    def test_advance_step_stores_previous_step(self, init_db):
        ...
        from lingwen_workflow import advance_step, set_state
...
class TestGetJson:
    ...
    def test_get_json_returns_value(self, sample_workflow_json):
        ...
        from lingwen_workflow import get_json
...
class TestGetStateReadLock:
    ...
    def test_get_state_uses_explicit_read_transaction(self, init_db, monkeypatch):
        ...
        """
        from lingwen_workflow import db, get_state, set_state
    ...
    def test_get_state_reads_consistent_snapshot(self, init_db):
        ...
        from lingwen_workflow import db, set_state
