"""Tests for lingwen_workflow.migration (migrate_json_to_sqlite).
...
class TestMigrateJsonToSqlite:
    ...
    def test_migrate_json_to_sqlite_returns_counts(self, sample_workflow_json):
        ...
        from lingwen_workflow import migrate_json_to_sqlite
    ...
    def test_migrate_json_to_sqlite_migrates_state(self, sample_workflow_json):
        ...
        from lingwen_workflow import get_state, migrate_json_to_sqlite
    ...
    def test_migrate_json_to_sqlite_migrates_tasks(self, sample_workflow_json):
        ...
        from lingwen_workflow import get_task_status, init_sqlite, migrate_json_to_sqlite
    ...
    def test_migrate_json_to_sqlite_handles_complex_values(self, mock_env):
        ...
        from lingwen_workflow import get_state, init_sqlite, migrate_json_to_sqlite
