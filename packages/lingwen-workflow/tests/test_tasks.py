"""Tests for lingwen_workflow.tasks (dispatch_task, verify_task, get_task_status, list_tasks).

Task layer: agent task lifecycle (dispatch → run → verify).

NOTE: TestDispatchTask.test_dispatch_task_triggers_event patches
`lingwen_workflow.events._trigger_event`. tasks.py must import as
...
class TestDispatchTask:
    ...
    def test_dispatch_task_returns_task_id(self, init_db):
        ...
        from lingwen_workflow import dispatch_task
    ...
    def test_dispatch_task_creates_pending_task(self, init_db):
        ...
        from lingwen_workflow import dispatch_task, get_task_status
    ...
    def test_dispatch_task_triggers_event(self, init_db):
        ...
        with patch("lingwen_workflow.events._trigger_event") as mock_trigger:
    ...
    def test_dispatch_task_multiple_tasks(self, init_db):
        ...
        from lingwen_workflow import dispatch_task, list_tasks
...
class TestVerifyTask:
    ...
    def test_verify_task_returns_true_on_success(self, init_db):
        ...
        from lingwen_workflow import dispatch_task, verify_task
    ...
    def test_verify_task_updates_status(self, init_db):
        ...
        from lingwen_workflow import dispatch_task, get_task_status, verify_task
    ...
    def test_verify_task_nonexistent_returns_true(self, init_db):
        ...
        from lingwen_workflow import verify_task
...
class TestGetTaskStatus:
    ...
    def test_get_task_status_returns_none_for_missing(self, init_db):
        ...
        from lingwen_workflow import get_task_status
...
class TestListTasks:
    ...
    def test_list_tasks_returns_list(self, init_db):
        ...
        from lingwen_workflow import list_tasks
