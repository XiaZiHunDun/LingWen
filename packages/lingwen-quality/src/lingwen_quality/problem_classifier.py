...
Phase 46 P3-ARCHDEBT: relocated from tools/problem_classifier.py (242 LOC).
Now an internal submodule of lingwen_quality (was using sys.path hack to
import from lingwen_quality.quality). Cross-module dependency removed.

Architecture note: This module was previously in tools/ with a sys.path
hack to reach lingwen_quality.quality.Issue. Now a clean relative
...
# Phase 46: sys.path hack REMOVED. Relative import within lingwen_quality package.
