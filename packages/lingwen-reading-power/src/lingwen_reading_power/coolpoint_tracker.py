...
Phase 57 P3-ARCHDEBT: relocated from infra/reading_power/coolpoint_tracker.py to
packages/lingwen-reading-power/src/lingwen_reading_power/coolpoint_tracker.py.
Canonical import: ``from lingwen_reading_power.coolpoint_tracker import CoolPointTracker``.
"""
