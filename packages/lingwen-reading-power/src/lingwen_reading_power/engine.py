"""
Reading Power Engine — 追读力系统主编排器.
Coordinates rule matching + LLM analysis for hybrid mode detection.

Phase 57 P3-ARCHDEBT: relocated from infra/reading_power/engine.py to
packages/lingwen-reading-power/src/lingwen_reading_power/engine.py.
Canonical import: ``from lingwen_reading_power.engine import ReadingPowerEngine``.
"""
