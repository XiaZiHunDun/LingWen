...
Phase 57 P3-ARCHDEBT: relocated from infra/reading_power/hook_tracker.py to
packages/lingwen-reading-power/src/lingwen_reading_power/hook_tracker.py.
Canonical import: ``from lingwen_reading_power.hook_tracker import HookTracker``.
"""
