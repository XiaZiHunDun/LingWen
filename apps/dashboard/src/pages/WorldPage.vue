<!--
  WorldPage.vue — Phase 117 (Task 12 / F) 世界页 skeleton
  /world route 入口,组成: PageLeadBar + WorldTabs + 4 个 tab 占位 stub.
  完整实现 (列表/编辑器/Graph/审核 inbox) 在 Phase 117 follow-up tasks.
-->
<template>
